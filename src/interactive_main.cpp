...
int main()
{
    CrossroadTrafficMonitoring monitor(std::chrono::milliseconds(600000)); // 10-minute period for auto-reset, can be changed as desired.
    int choice;
    ...
    do
    {
        ...
        case 1:
        {
            ...
            if (oldState == newState)
            {
                ...
                {
                    // oldState == State::Init but the transition code didn't switch to Active
        ...
        case 3:
        {
            ...
            if (newState == State::Active)
            {
                std::cout << "Monitoring reset. System is now Active. Error count and stats cleared.\n";
            }
            else
            {
        ...
        case 4:
        {
            ...
            {
                std::cout << "Vehicle signal counted as an error (Error state). Not added to stats.\n";
            }
            else if (beforeSignal == State::Active && afterSignal == State::Active)
            {
        ...
        case 5:
        {
            ...
            {
                // Possibly increments error count if your code does that for first empty signal
